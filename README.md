...
> 🆕 **เพิ่งเข้ามาใหม่ / อยากเข้าใจภาพรวมระบบ?** อ่าน [**📘 PROJECT_OVERVIEW.md**](./PROJECT_OVERVIEW.md) ก่อน — อธิบายตั้งแต่ศูนย์ พร้อมแผนผัง (flowchart/diagram) ว่าแต่ละ service ทำงานยังไง ไฟล์ README นี้เน้นวิธี **ติดตั้งและรัน**
